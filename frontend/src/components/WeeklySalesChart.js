              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <Paper sx={{ p: 2, background: "rgba(103, 126, 234, 0.1)" }}>
                  ...
                  >
                    📈 Best Day:{" "}
                    {
                      Object.entries(selectedWeekData.dailyBreakdown).reduce(
                        (a, b) => (a[1] > b[1] ? a : b)
                      )[0]
                    }
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    £
                    {Math.max(
                      ...Object.values(selectedWeekData.dailyBreakdown)
                    ).toFixed(2)}
                  </Typography>
                </Paper>
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <Paper sx={{ p: 2, background: "rgba(118, 75, 162, 0.1)" }}>
                  ...
                  >
                    💰 Top Payment:{" "}
                    {
                      Object.entries(selectedWeekData.paymentBreakdown).reduce(
                        (a, b) => (a[1] > b[1] ? a : b)
                      )[0]
                    }
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    £
                    {Math.max(
                      ...Object.values(selectedWeekData.paymentBreakdown)
                    ).toFixed(2)}
                  </Typography>
                </Paper>
              </Grid>
